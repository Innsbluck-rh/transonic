...
const SPPlayerBar: Component<PlayerBarProps> = (props) => {
  ...
  return (
    <div class='bg-primary-plane ripple relative flex w-full flex-col overflow-hidden rounded-xl shadow-lg'>
      <Show when={coverArt()}>
      ...
      ></div>
      <div class='relative z-10 flex size-full flex-row items-center gap-4 px-4 py-2.5 shadow-xl lg:p-5 lg:px-6'>
        ...
        <div {...props.restAreaProps} class={`flex min-w-0 flex-1 items-center ${restAreaClass() ?? ''}`} onClick={onClickRestArea}>
          <div class='flex min-w-0 flex-1 flex-col'>
            <MarqueeParagraph
              ...
              class='archivo text-primary-text -mb-0.5 w-full text-lg font-black tracking-tighter'
              classList={{
